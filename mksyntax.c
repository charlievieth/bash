...
struct wordflag {
    ...
    {CWORD, "CWORD"},       {CSHMETA, "CSHMETA"},   {CSHBRK, "CSHBRK"}, {CBACKQ, "CBACKQ"},
    {CQUOTE, "CQUOTE"},     {CSPECL, "CSPECL"},     {CEXP, "CEXP"},     {CBSDQUOTE, "CBSDQUOTE"},
    {CBSHDOC, "CBSHDOC"},   {CGLOB, "CGLOB"},       {CXGLOB, "CXGLOB"}, {CXQUOTE, "CXQUOTE"},
...
static void addcstr(str, flag) char *str;
int flag;
{
	char *s, *fstr;
	unsigned char uc;
...
static void addcchar(c, flag) unsigned char c;
int flag;
{
	char *fstr;
...
static void dump_lflags(fp, ind) FILE *fp;
int ind;
{
	int xflags, first, i;
...
static void wcomment(fp, i) FILE *fp;
int i;
{
	fputs("\t\t/* ", fp);
