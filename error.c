...
#else
    programming_error(format, va_alist) const char *format;
va_dcl
#endif
{
	va_list args;
...
#else
    report_error(format, va_alist) const char *format;
va_dcl
#endif
{
	va_list args;
...
#else
    fatal_error(format, va_alist) const char *format;
va_dcl
#endif
{
	va_list args;
...
#else
    internal_error(format, va_alist) const char *format;
va_dcl
#endif
{
	va_list args;
...
#else
    internal_warning(format, va_alist) const char *format;
va_dcl
#endif
{
	va_list args;
...
#else
    internal_inform(format, va_alist) const char *format;
va_dcl
#endif
{
	va_list args;
...
#else
    internal_debug(format, va_alist) const char *format;
va_dcl
#endif
{
#ifdef DEBUG
...
#else
    sys_error(format, va_alist) const char *format;
va_dcl
#endif
{
	int e;
...
#else
    parser_error(lineno, format, va_alist) int lineno;
const char *format;
va_dcl
#endif
{
...
char *strescape(str) const char *str;
{
	char *r, *result;
	unsigned char *s;
...
#else
    itrace(format, va_alist) const char *format;
va_dcl
#endif
{
	va_list args;
...
#else
    trace(format, va_alist) const char *format;
va_dcl
#endif
{
	va_list args;
...
static const char *const cmd_error_table[] = {N_("unknown command error"), /* CMDERR_DEFAULT */
