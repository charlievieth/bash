...
void array_dispose_elements(elist) ARRAY_ELEMENT **elist;
{
	arrayind_t i;
...
static ARRAY_ELEMENT **array_copy_elements(a)
ARRAY *a;
{
	ARRAY_ELEMENT **ret;
	arrayind_t i;
 ...
 */
static char *array_to_string_internal(a, start, end, sep, quoted)
ARRAY *a;
