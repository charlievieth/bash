...
#define SX_POSIXEXP \
	0x0100 /* extracting new Posix pattern removal expansions in extract_dollar_brace_string */
...
#define SD_NOSKIPCMD \
	0x008 /* don't skip over $(, <(, or >( command/process substitution; parse them as commands */
