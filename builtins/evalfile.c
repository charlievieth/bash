...
static int _evalfile(filename, flags) const char *filename;
int flags;
{
...
int maybe_execute_file(fname, force_noninteractive) const char *fname;
...
int force_execute_file(fname, force_noninteractive) const char *fname;
int force_noninteractive;
{
	char *filename;
	int result, flags;
...
#if defined(HISTORY)
int fc_execute_file(filename) const char *filename;
{
	int flags;
...
int source_file(filename, sflags) const char *filename;
int sflags;
{
	int flags, rval;
