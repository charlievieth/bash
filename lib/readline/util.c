...
int _rl_null_function(int count, int key) {
	return 0;
}
...
#else  /* !USE_VARARGS */
void _rl_ttymsg(format, arg1, arg2) char *format;
{
	fprintf(stderr, "readline: ");
...
void _rl_errmsg(format, arg1, arg2) char *format;
{
	fprintf(stderr, "readline: ");
	fprintf(stderr, format, arg1, arg2);
	fprintf(stderr, "\n");
