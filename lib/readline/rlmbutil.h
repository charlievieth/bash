...
#include <wchar.h>
#include <wctype.h>
#if defined(HAVE_ISWCTYPE) && defined(HAVE_ISWLOWER) && defined(HAVE_ISWUPPER) && \
    defined(HAVE_MBSRTOWCS) && defined(HAVE_MBRTOWC) && defined(HAVE_MBRLEN) &&   \
    defined(HAVE_TOWLOWER) && defined(HAVE_TOWUPPER) && defined(HAVE_WCHAR_T) &&  \
...
#define MB_NEXTCHAR(b, s, c, f)                                                             \
	((MB_CUR_MAX > 1 && rl_byte_oriented == 0) ? _rl_find_next_mbchar((b), (s), (c), (f)) : \
	                                             ((s) + (c)))
#define MB_PREVCHAR(b, s, f) \
	((MB_CUR_MAX > 1 && rl_byte_oriented == 0) ? _rl_find_prev_mbchar((b), (s), (f)) : ((s)-1))
