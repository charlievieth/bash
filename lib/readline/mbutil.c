...
static int _rl_utf8_mblen(const char *s, size_t n) {
...
static int _rl_find_next_mbchar_internal(char *string, int seed, int count, int find_non_zero) {
	size_t tmp, len;
	mbstate_t ps;
	int point;
	WCHAR_T wc;
...
static inline int _rl_test_nonzero(char *string, int ind, int len) {
	size_t tmp;
	WCHAR_T wc;
	mbstate_t ps;
...
static int _rl_find_prev_utf8char(char *string, int seed, int find_non_zero) {
	char *s;
	unsigned char b;
	int save, prev;
	size_t len;
...
/*static*/ int _rl_find_prev_mbchar_internal(char *string, int seed, int find_non_zero) {
	mbstate_t ps;
...
int _rl_get_char_len(char *src, mbstate_t *ps) {
	size_t tmp, l;
	int mb_cur_max;
...
int _rl_compare_chars(char *buf1, int pos1, mbstate_t *ps1, char *buf2, int pos2, mbstate_t *ps2) {
	int i, w1, w2;
...
/* adjust pointed byte and find mbstate of the point of string.
   ...
   it returns -1 */
int _rl_adjust_point(char *string, int point, mbstate_t *ps) {
	size_t tmp;
	int length, pos;
...
int _rl_is_mbchar_matched(char *string, int seed, int end, char *mbchar, int length) {
	int i;
...
int _rl_find_next_mbchar(char *string, int seed, int count, int flags) {
#if defined(HANDLE_MULTIBYTE)
