...
struct timeval *difftimeval(d, t1, t2)
...
struct timeval *addtimeval(d, t1, t2)
struct timeval *d, *t1, *t2;
{
...
void timeval_to_secs(tvp, sp, sfp) struct timeval *tvp;
time_t *sp;
int *sfp;
{
	int rest;
...
/* Print the contents of a struct timeval * in a standard way to stdio
   stream FP.  */
void print_timeval(fp, tvp) FILE *fp;
struct timeval *tvp;
{
	time_t timestamp;
	long minutes;
