...
static int _getserv(serv, proto, pp)
char *serv;
int proto;
unsigned short *pp;
{
 ...
 */
static int _netopen4(host, serv, typ)
char *host, *serv;
int typ;
{
	struct in_addr ina;
 ...
 * on error.
 */
static int _netopen6(host, serv, typ)
char *host, *serv;
int typ;
{
	int s, e;
 ...
 */
static int _netopen(host, serv, typ)
char *host, *serv;
int typ;
{
#ifdef HAVE_GETADDRINFO
