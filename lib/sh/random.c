...
static u_bits32_t intrand32(last)
u_bits32_t last;
{
...
static void sbrand32(seed) u_bits32_t seed;
...
static ssize_t getrandom(buf, len, flags) void *buf;
size_t len;
unsigned int flags;
{
	int oflags;
