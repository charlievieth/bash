...
/* Sets the original and the current installation prefix of this module.
   ...
   instead of "/").  */
static void set_this_relocation_prefix(const char *orig_prefix_arg, const char *curr_prefix_arg) {
	if (orig_prefix_arg != NULL &&
	    curr_prefix_arg != NULL
...
/* Sets the original and the current installation prefix of the package.
   ...
   prefixes should be directory names without trailing slash (i.e. use ""
   instead of "/").  */
void set_relocation_prefix(const char *orig_prefix_arg, const char *curr_prefix_arg) {
...
static void find_shared_library_fullname() {
#ifdef __linux__
	FILE *fp;
...
static char *get_shared_library_fullname() {
#if !(defined _WIN32 || defined __WIN32__)
