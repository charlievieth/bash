...
extern void FREE_EXPRESSION PARAMS((struct expression * exp)) internal_function;
...
extern unsigned long int plural_eval PARAMS((struct expression * pexp, unsigned long int n));
#endif
