...
#define INT_STRLEN_BOUND(t) ((TYPE_WIDTH(t) - TYPE_SIGNED(t)) * 302 / 1000 + 1 + TYPE_SIGNED(t))
...
#if 0
#define INT_STRLEN_BOUND(t) (INT_BITS_STRLEN_BOUND(TYPE_WIDTH(t) - TYPE_SIGNED(t)) + TYPE_SIGNED(t))
#endif
...
#define REVERSE_LIST(list, type) \
	((list && list->next) ? (type)list_reverse((GENERIC_LIST *)list) : (type)(list))
