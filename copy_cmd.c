...
static PATTERN_LIST *copy_case_clauses(clauses)
...
REDIRECT *copy_redirect(redirect)
REDIRECT *redirect;
{
...
static FOR_COM *copy_for_command(com)
FOR_COM *com;
{
	FOR_COM *new_for;
...
#if defined(ARITH_FOR_COMMAND)
static ARITH_FOR_COM *copy_arith_for_command(com)
ARITH_FOR_COM *com;
{
...
static SUBSHELL_COM *copy_subshell_command(com)
SUBSHELL_COM *com;
{
...
static CASE_COM *copy_case_command(com)
CASE_COM *com;
{
	CASE_COM *new_case;
...
static WHILE_COM *copy_while_command(com)
WHILE_COM *com;
{
	WHILE_COM *new_while;
...
static IF_COM *copy_if_command(com)
IF_COM *com;
{
	IF_COM *new_if;
...
#if defined(DPAREN_ARITHMETIC)
static ARITH_COM *copy_arith_command(com)
ARITH_COM *com;
{
	ARITH_COM *new_arith;
...
#if defined(COND_COMMAND)
static COND_COM *copy_cond_command(com)
COND_COM *com;
{
	COND_COM *new_cond;
...
FUNCTION_DEF *copy_function_def_contents(old, new_def)
...
FUNCTION_DEF *copy_function_def(com)
FUNCTION_DEF *com;
{
