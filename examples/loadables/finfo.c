...
static int finfo_main(argc, argv)
int argc;
char **argv;
{
	register int i;
...
static char *finfo_doc[] = {"Display information about file attributes.",
                            "",
...
int legal_number(string, result)
char *string;
long *result;
{
	int sign;
...
#else
void builtin_error(format, arg1, arg2, arg3, arg4, arg5) char *format, *arg1, *arg2, *arg3, *arg4,
    *arg5;
{
	if (this_command_name && *this_command_name)
		fprintf(stderr, "%s: ", this_command_name);
