...
#ifndef O_CLOEXEC
#define ALLFLAGS                                                                         \
	(O_APPEND | O_ASYNC | O_SYNC | O_NONBLOCK | O_FSYNC | O_DSYNC | O_RSYNC | O_ALT_IO | \
	 O_DIRECT | O_NOATIME | O_NOSIGPIPE)
...
char *fdflags_doc[] = {"Display and modify file descriptor flags.",
                       "",
