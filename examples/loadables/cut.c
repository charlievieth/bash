...
static int cutbytes(v, line, ops)
SHELL_VAR *v;
char *line;
struct cutop *ops;
{
...
static int cutchars(v, line, ops)
SHELL_VAR *v;
char *line;
struct cutop *ops;
{
...
static int cutfields(v, line, ops)
SHELL_VAR *v;
char *line;
struct cutop *ops;
{
...
static int cut_internal(which, list)
...
int lcut_builtin(list)
WORD_LIST *list;
{ return (cut_internal(0, list)); }

int cut_builtin(list)
WORD_LIST *list;
{ return (cut_internal(1, list)); }

char *lcut_doc[] = {"Extract selected fields from a string.",
                    "",
...
struct builtin lcut_struct = {
    ...
    "lcut [-a ARRAY] [-b LIST] [-c LIST] [-f LIST] [-d CHAR] [-sn] line", /* usage synopsis; becomes
                                                                             short_doc */
    0 /* reserved for internal use */
};

char *cut_doc[] = {"Extract selected fields from each line of a file.",
                   "",
...
struct builtin cut_struct = {
    ...
    "cut [-a ARRAY] [-b LIST] [-c LIST] [-f LIST] [-d CHAR] [-sn] [file ...]", /* usage synopsis;
                                                                                  becomes short_doc
                                                                                */
    0 /* reserved for internal use */
};
