...
static int sort_index(SHELL_VAR *dest, SHELL_VAR *source) {
	HASH_TABLE *hash;
...
static int sort_inplace(SHELL_VAR *var) {
	size_t i, n;
	ARRAY *a;
	ARRAY_ELEMENT *ae;
	sort_element *sa = 0;
...
char *asort_doc[] = {"Sort arrays in-place.",
                     "",
                     "Options:",
...
struct builtin asort_struct = {"asort",
                               asort_builtin,
                               BUILTIN_ENABLED,
                               asort_doc,
