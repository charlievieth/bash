...
static int accept_bind_variable(varname, intval)
char *varname;
int intval;
{
	SHELL_VAR *v;
...
char *accept_doc[] = {"Accept a network connection on a specified port.",
                      ""
...
struct builtin accept_struct = {
    ...
    "accept [-b address] [-t timeout] [-v varname] [-r addrvar ] port", /* usage synopsis; becomes
                                                                           short_doc */
