...
char *logname_doc[] = {"Display user login name.",
                       "",
...
struct builtin logname_struct = {"logname",   logname_builtin, BUILTIN_ENABLED,
                                 logname_doc, "logname",       0};
