...
static int dsvsplit(dsv, line, dstring, flags)
SHELL_VAR *dsv;
char *line, *dstring;
int flags;
{
...
int dsv_builtin_load(name)
char *name;
{ return (1); }

/* Called when builtin is disabled. */
void dsv_builtin_unload(name) char *name;
{}

char *dsv_doc[] = {"Read delimiter-separated fields from STRING.",
                   "",
