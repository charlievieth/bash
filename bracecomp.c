...
static char *really_munge_braces(array, real_start, real_end, gcd_zero)
char **array;
...
static int hack_braces_completion(names)
char **names;
{
	register int i;
	char *temp;
...
int bash_brace_completion(count, ignore)
int count, ignore;
{
