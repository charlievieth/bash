...
typedef struct variable *
    sh_var_assign_func_t PARAMS((struct variable *, char *, arrayind_t, char *));
...
#define user_attrs                                                                       \
	(att_exported | att_readonly | att_integer | att_local | att_trace | att_uppercase | \
	 att_lowercase | att_capcase | att_nameref)
